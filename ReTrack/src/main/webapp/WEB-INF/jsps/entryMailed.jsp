...
<stripes:layout-render name="${layout}" title="Entry Mailed"
			...
			<table border="1" cellspacing="0" align="center" width="100%">
				<tr>
					<td align="left" class="prmt">&nbsp;
						<stripes:label name="entry.mail.date" /></td>
					<td align="left">&nbsp;
						<stripes:text name="date" id="mailed.date" class="text_field" size="20" />
					</td>
				</tr>
				<tr>
					<td align="left" colspan="2">&nbsp;&nbsp;<stripes:submit
							class="submit_btn" name="entryMailed" value="Mark as 'Mailed'" />
					</td>
				</tr>
			</table>
		</stripes:form>
