...
<stripes:layout-render name="${layout}" title="Entry Received"
			...
			<table border="1" cellspacing="0" align="center" width="100%">
				<tr>
					<td align="left" class="prmt">&nbsp;
						<stripes:label name="entry.received.date" /></td>
					<td align="left">&nbsp;
						<stripes:text name="date" id="received.date" class="text_field" size="20" />
					</td>
				</tr>
				<tr>
					<td align="left" colspan="2">&nbsp;&nbsp;<stripes:submit
							class="submit_btn" name="entryReceived" value="Mark as 'Received'" />
					</td>
				</tr>
			</table>
		</stripes:form>
