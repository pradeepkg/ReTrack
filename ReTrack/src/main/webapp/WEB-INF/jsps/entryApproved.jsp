			...
			<table border="1" cellspacing="0" align="center" width="100%">
				<tr>
					<td align="left" class="prmt">&nbsp;
						<stripes:label name="entry.approved.date" /></td>
					<td align="left">&nbsp;
						<stripes:text name="date" id="approved.date" class="text_field" size="20" />
					</td>
				</tr>
				<tr>
					<td align="left" colspan="2">&nbsp;&nbsp;<stripes:submit
							class="submit_btn" name="entryApproved" value="Mark as 'Approved'" />
					</td>
				</tr>
			</table>
		</stripes:form>
